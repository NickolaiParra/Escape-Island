...
while running:
    ...
    if num_dialog == -1:
        ...
        t2 = "El aire misterioso de condiciona a seguir."
        ...
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Ah, pero si eres un joven aventurero."
        ...
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Básicamente esto significa que si se cumple una condición que tu le pongas,"
        ...
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Principalmente se puede hacer comparando dos distintos valores."
        t2 = "Digamos: 2 > 9 (2 es mayor que 9)"
        t3 = "Eso sería falso por lo que no ejecutaría la condición."
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 11:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        ...
        t2 = "a = 10"
        t3 = "y evaluamos la condición a >= 6 (La variable a es mayor o igual a 6)"
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 12:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Esto sería verdadero, ya que como a es 10, y 10 >= 6 se cumple la condición."
        ...
        t2 = "También puedes comparar cadenas de texto."
        t3 = "Por ejemplo..."
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 15:
        EI.PANTALLA.blit(condi,condi_rect)
        ...
        t3 = "A parte es esto solo tienes una forma más de tener condiciones: con booleanos."
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 16:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Ya que los booleanos son valores de falso o verdadero también se pueden usar en una condición."
        t2 = "Si tienes un variable que sea condicion = True."
        t3 = "Cuando metas la condición en un condicional se va a ejecutar el código ya que es 'True'."
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 17:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Lo mismo pasa con False."
        t2 = "Si tienes  condicion = False."
        ...
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Digamos que tenemos una condición a = True y otra b = False"
        t2 = "Al usar el operador de 'and' las dos condiciones tienen que ser verdadares para que se cumpla."
        t3 = "Por ejemplo: 'a and b' es falso ya que b es falso (False)."
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 20:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        ...
        t3 = "Siguiendo el ejemplo anterior 'a or b' sería verdadero ya que a es verdadero (True)."
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 21:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        ...
        t3 = "Sería verdadeo ya que c > b es verdadero, aún así a > b no lo sea."
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 22:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Eso sería la teoría de cómo funciona un condicional."
        t2 = "Si necesitas volver para revisar algo de lo que dije. Es bastante información."
        ...
        t2 = "Mira que se bastante fácil."
        EI.mostrar_texto(personaje,t1,t2)
    elif num_dialog == 28:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Significa que al principio de la línea tienes que dejar unos espacios."
        t2 = "Para hacerlo puedes dejar 4 espacios o hacerlo con la tecla TAB."
        t3 = "Esto con el objetivo de indicar qué es lo que va dentro del condicional."
        EI.mostrar_texto(personaje,t1,t2,t3)
    elif num_dialog == 29:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        ...
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Existe dos estructuras que son 'else' y 'elif'"
        ...
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        t1 = "Básicamente que con 'elif' puedes escribir una segunda condición de la siguiente manera:"
        ...
        t2 = "Una tercera, cuarta, décima o las veces que quieras."
        EI.mostrar_texto(personaje,t1,t2)
    elif num_dialog == 34:
        EI.PANTALLA.blit(condi,condi_rect)
        personaje = "Condi"
        ...
        t2 = ""
        t3 = ""
        a = "Para indicar que el código que se escribe está dentro de una estructura específica"
        ...
        personaje = "Condi"
        t1 = "Excelente, joven."
        t2 = "Haz adquirido un gran cconocimiento."
        ...
        d = "Para comparar dos números o cadenas."
        pregunta("Examen de condicionales",[t1,t2,t3],a,b,c,d)
    elif num_dialog == 44:
        #Pregunta 2
